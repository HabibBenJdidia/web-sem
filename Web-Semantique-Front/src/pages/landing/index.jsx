  ...
  return (
    <div className="landing-page">
      ...
      <main className="main" id="top">
        ...
        {/* Restaurants & Local Products Section */}
        <section className="pt-5 pt-md-9" id="restaurants-products" style={{ backgroundColor: '#f8f9fa' }}>
          <div className="container">
            <div className="mb-7 text-center">
              <h5 className="text-secondary">LOCAL EXPERIENCE</h5>
              <h3 className="fs-xl-10 fs-lg-8 fs-7 fw-bold font-cursive text-capitalize">
                Restaurants & Local Products
              </h3>
              <p className="text-muted fw-medium">Discover authentic eco-friendly restaurants and fresh local products</p>
            </div>
            
            <div className="row g-4">
              {/* Restaurants Card */}
              <div className="col-lg-6 mb-4">
                <div className="card h-100 shadow-lg border-0 overflow-hidden hover-lift" style={{ transition: 'transform 0.3s' }}>
                  <div className="position-relative">
                    ...
                    >
                      <div className="text-center text-white">
                        ...
                        <h3 className="fw-bold mb-0">Eco-Restaurants</h3>
                      </div>
                    </div>
                    <div className="position-absolute top-0 end-0 m-3">
                      <span className="badge bg-success px-3 py-2">
                        <i className="fas fa-leaf me-1"></i>Eco-Friendly
                      </span>
                    </div>
                  </div>
                  <div className="card-body p-4">
                    <h4 className="fw-bold mb-3 text-secondary">Discover Local Restaurants</h4>
                    <p className="text-muted mb-4">
                      Explore eco-friendly restaurants serving authentic local cuisine with organic and 
                      seasonal products. Support local businesses while enjoying sustainable dining.
                    </p>
                    <ul className="list-unstyled mb-4">
                      <li className="mb-2">
                        <i className="fas fa-check-circle text-success me-2"></i>
                        <span className="fw-medium">Organic & Local Ingredients</span>
                      </li>
                      <li className="mb-2">
                        <i className="fas fa-check-circle text-success me-2"></i>
                        <span className="fw-medium">Eco-Certified Establishments</span>
                      </li>
                      <li className="mb-2">
                        <i className="fas fa-check-circle text-success me-2"></i>
                        <span className="fw-medium">Support Local Community</span>
                      </li>
                    </ul>
                    <Link to="/restaurants" className="btn btn-primary w-100 fw-bold">
                      Browse Restaurants
                  ...
                  <div className="position-relative">
                    ...
                    >
                      <div className="text-center text-white">
                        ...
                        <h3 className="fw-bold mb-0">Local Products</h3>
                      </div>
                    </div>
                    <div className="position-absolute top-0 end-0 m-3">
                      <span className="badge bg-warning px-3 py-2">
                        <i className="fas fa-star me-1"></i>Fresh & Seasonal
                      </span>
                    </div>
                  </div>
                  <div className="card-body p-4">
                    <h4 className="fw-bold mb-3 text-secondary">Fresh Local Products</h4>
                    <p className="text-muted mb-4">
                      Find fresh, seasonal, and organic products from local farmers and producers. 
                      Experience authentic flavors while supporting sustainable agriculture.
                    </p>
                    <ul className="list-unstyled mb-4">
                      <li className="mb-2">
                        <i className="fas fa-check-circle text-warning me-2"></i>
                        <span className="fw-medium">Seasonal & Fresh Products</span>
                      </li>
                      <li className="mb-2">
                        <i className="fas fa-check-circle text-warning me-2"></i>
                        <span className="fw-medium">Organic Certified Options</span>
                      </li>
                      <li className="mb-2">
                        <i className="fas fa-check-circle text-warning me-2"></i>
                        <span className="fw-medium">Direct from Local Farmers</span>
                      </li>
                    </ul>
                    <Link to="/produits" className="btn btn-danger w-100 fw-bold">
                      Browse Products
                      <i className="fas fa-arrow-right ms-2"></i>
                    </Link>
                  </div>
            ...
            <div className="row mt-5 pt-4">
              <div className="col-md-4 mb-4">
                <div className="text-center p-4 bg-white rounded shadow-sm">
                  <div className="display-4 fw-bold text-primary mb-2">🍽️</div>
                  <h4 className="fw-bold text-secondary mb-1">Restaurants</h4>
                  <p className="text-muted mb-0">Eco-friendly dining experiences</p>
                </div>
              </div>
              <div className="col-md-4 mb-4">
                <div className="text-center p-4 bg-white rounded shadow-sm">
                  <div className="display-4 fw-bold text-success mb-2">🌱</div>
                  <h4 className="fw-bold text-secondary mb-1">Organic</h4>
                  <p className="text-muted mb-0">Certified organic products</p>
                </div>
              </div>
              <div className="col-md-4 mb-4">
                <div className="text-center p-4 bg-white rounded shadow-sm">
                  <div className="display-4 fw-bold text-warning mb-2">⭐</div>
                  <h4 className="fw-bold text-secondary mb-1">Seasonal</h4>
                  <p className="text-muted mb-0">Fresh seasonal produce</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="row align-items-center">
              <div className="col-lg-5 mb-5 mb-lg-0">
                <div className="testimonial-header">
                  <h5 className="text-secondary text-uppercase">TESTIMONIALS</h5>
                  <h3 className="fs-xl-10 fs-lg-8 fs-7 fw-bold font-cursive">What people say<br />about Us.</h3>
                </div>
              </div>
              <div className="col-lg-1"></div>
              <div className="col-lg-6">
                <div className="testimonial-carousel-wrapper">
                  <div className="carousel slide position-relative" id="testimonialIndicator" data-bs-ride="carousel" data-bs-interval="5000">
                    <div className="carousel-inner">
                        ...
                        <div className="testimonial-card">
                          <div className="testimonial-content">
                            ...
                            <div className="testimonial-author">
                              <img className="author-img" src="/assets/img/testimonial/author.png" alt="Mike taylor" />
                              <div className="author-info">
                                <h6 className="author-name">Mike taylor</h6>
                      ...
                      <div className="carousel-item">
                        <div className="testimonial-card">
                          <div className="testimonial-content">
                            <p className="testimonial-text">
                              "Amazing eco-friendly experience! The local guides were knowledgeable and the 
                              sustainable practices were evident everywhere. Highly recommend!"
                            </p>
                            <div className="testimonial-author">
                              <img className="author-img" src="/assets/img/testimonial/author2.png" alt="Thomas wagon" />
                              <div className="author-info">
                                <h6 className="author-name">Thomas Wagon</h6>
                                <p className="author-location">CEO of Red Button</p>
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="carousel-item">
                        <div className="testimonial-card">
                          <div className="testimonial-content">
                            <p className="testimonial-text">
                              "The organic local products were exceptional! Supporting sustainable tourism 
                              while enjoying authentic experiences. This is the future of travel."
                            </p>
                            <div className="testimonial-author">
                              <img className="author-img" src="/assets/img/testimonial/author3.png" alt="Ama Ampomah" />
                              <div className="author-info">
                                <h6 className="author-name">Ama Ampomah</h6>
                                <p className="author-location">CEO of MTN</p>
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <div className="carousel-indicators-wrapper">
                      <ol className="carousel-indicators position-static">
                        <li data-bs-target="#testimonialIndicator" data-bs-slide-to="0" className="active"></li>
            ...
            <div className="row justify-content-md-between justify-content-evenly py-3">
              ...
              <div className="col-12 col-sm-8 col-md-6">
                <p className="fs--1 my-2 text-center text-md-end text-200">
                  Made with ❤️ by <span className="fw-bold text-secondary">EcoTourist Team</span>
                </p>
              </div>
            </div>
          </div>
